...
import {
    ...
    aylikKaliteAnahtar, aylikBirlestir, RaporSatir,
...
import { maliyetCek, maliyetOzet, MaliyetSatir } from '../utils/kaliteMaliyet';
...
const AylikKaliteModal: React.FC<Props> = ({ isOpen, onClose, kpis, lokasyon, yil }) => {
    ...
    }, [kayitlar, onayli, maliyet, kpis, lokasyon, yil, ay]);
                            ...
                            {satirlar.map(s => (
                                <tr key={s.id} className="border-b border-gray-200 dark:border-gray-700 align-top">
                                    <td className="px-3 py-2">
                                        ...
                                        <textarea rows={3} value={gosterilenOto(s)}
