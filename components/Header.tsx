...
const Header: React.FC<HeaderProps> = ({ year, allKpis, filters, setFilters, onAddKpi, onImport, onImportXlsx, onExport, onExportXlsx, exportLabel, locations, currentLocation, onChangeLocation, onManageLocations, cloudStatus, onCloudRefresh, onCopyYear, onFillPrevYear, darkMode, onToggleDark, onBulkSonGuncelleme, onNavigateYear, isSummaryOpen, setSummaryOpen, onGeneratePdf, onOpenDofPanel, onBulkDelete, onOpenModal }) => {
    ...
    return (
        <header className="relative bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md no-print">
            <span className="absolute top-2 right-4 text-xs text-gray-400 dark:text-gray-500 font-mono">v4.7</span>
            <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="flex flex-wrap items-center gap-2">
                    ...
                    <button onClick={onExport} className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm hover:bg-gray-50 dark:hover:bg-gray-600">
                     ...
                     <button onClick={() => onOpenModal('aylik-kalite')} title="Kalite Raporu — bu lokasyon için (ay seçilir)" className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm hover:bg-gray-50 dark:hover:bg-gray-600">
                        <ClipboardDocumentListIcon className="w-4 h-4" /> Kalite Raporu
                     </button>
